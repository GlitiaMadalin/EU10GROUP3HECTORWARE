...
public class BrowserUtils {
    ...
    public static void verifyTitle(String expectedTitle){
        ...
        Assert.assertEquals(Driver.getDriver(), expectedTitle);
    ...
    // This method will accept a dropdown as a web element and return all the options text in a list of String.
    public static List<String> dropdownOptionsAsString(WebElement dropdownElement){
        ...
        for (WebElement each : actualOptionsAsWebElement) { // Getting each web element (month) and storing them into a list of String.
